...
public class Button() : UIElement(nameof(Button))
{
    ...
    {
        if (name.Equals("mouseoverimage", StringComparison.OrdinalIgnoreCase))
        {
            MouseOverImage = value as string;
        }
        else if (name.Equals("notpressedimage", StringComparison.OrdinalIgnoreCase))
        {
            NotPressedImage = value as string;
        }
        else if (name.Equals("pressedimage", StringComparison.OrdinalIgnoreCase))
        {
